...
public class CustomAdater extends RecyclerView.Adapter<CustomAdater.viewHolder> {
    Context context;
    ArrayList<itemModel> itemModelArrayList;

    public CustomAdater(Context context, ArrayList<itemModel> itemModelArrayList) {
    ...
    @NonNull
    @Override
    public CustomAdater.viewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(context).inflate(R.layout.itemlist,viewGroup,false);
        return new viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final CustomAdater.viewHolder viewHolder, final int position) {
