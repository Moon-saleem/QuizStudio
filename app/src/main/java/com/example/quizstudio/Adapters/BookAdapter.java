...
public class BookAdapter extends RecyclerView.Adapter<BookAdapter.bookViewHolder> {
    ...
    public BookAdapter(Context context, ArrayList<subjectModel> subjectModelArrayList) {
    ...
    @NonNull
    @Override
    public BookAdapter.bookViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
